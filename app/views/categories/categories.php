...
<!-- =====================================================
     ...
     ===================================================== -->
<section class="qs_section">
    <div class="qs_left">
        <img class="qs_bg_img"
             src="https://shtheme.com/demosd/wokrate/wp-content/uploads/2019/12/news_bg-1.jpg"
             alt="Quality Service background">
        <div class="qs_left_inner">
            <h2 class="qs_title">Quality Service</h2>
            <span class="qs_divider"></span>
            <p class="qs_desc">Capitalize on low hanging fruit to identify a ballpark value added activity to beta test. Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.</p>
            <a href="#" class="qs_btn">More News</a>
        </div>
    </div>
    <div class="qs_right">
        <div class="qs_right_inner">
            <h4 class="qs_right_title">Collaboratively administrate empowered markets</h4>
