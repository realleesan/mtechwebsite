...
<form method="POST" action="/projects/store" enctype="multipart/form-data" onsubmit="return validateProjectForm()">
    <div class="admin-form-card project-form-tabs">
            ...
            <div class="tab-pane fade show active" id="specs" role="tabpanel">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control form-control-lg" id="title" name="title" placeholder="Nhập tên dự án..." required>
                    </div>

                    <div class="col-md-6">
                        <label for="slug" class="form-label fw-bold">Slug URL <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="slug" name="slug" placeholder="ten-du-an" required>
                        <div class="form-text">Đường dẫn thân thiện, tự động tạo từ tên dự án</div>
                    </div>

                    <div class="col-md-6">
                        <label for="capacity" class="form-label fw-bold">2. Công suất</label>
                        <input type="text" class="form-control" id="capacity" name="capacity" placeholder="Ví dụ: 12.000 tấn clinker/ngày">
                    </div>

                    <div class="col-md-6">
                        <label for="location" class="form-label fw-bold">3. Địa điểm xây dựng</label>
                        <input type="text" class="form-control" id="location" name="location" placeholder="Ví dụ: Xã Thanh Nghị, Huyện Thanh Liêm, Tỉnh Hà Nam">
                    </div>

                    <div class="col-md-6">
                        <label for="client" class="form-label fw-bold">4. Chủ đầu tư dự án</label>
                        <input type="text" class="form-control" id="client" name="client" placeholder="Ví dụ: Công ty Cổ phần Xi măng Xuân Thành">
                    </div>

                    <div class="col-md-6">
                        <label for="total_investment" class="form-label fw-bold">5. Tổng mức đầu tư</label>
                        <input type="text" class="form-control" id="total_investment" name="total_investment" placeholder="Ví dụ: 10.500 tỷ VNĐ">
                    </div>

                    <div class="col-md-6">
                        <label for="construction_year" class="form-label fw-bold">6. Năm xây dựng / hoàn thành</label>
                        <input type="text" class="form-control" id="construction_year" name="construction_year" placeholder="Ví dụ: 2021 - 2023">
                    </div>

                    <div class="col-md-6">
                        <label for="bidding_form" class="form-label fw-bold">7. Hình thức gói thầu (EP/EPC)</label>
                        <input type="text" class="form-control" id="bidding_form" name="bidding_form" placeholder="Ví dụ: EPC (Thiết kế - Cung cấp thiết bị - Thi công)">
                    </div>

                    <div class="col-md-6">
                        <label for="equipment_contractor" class="form-label fw-bold">8. Nhà thầu cung cấp thiết bị</label>
                        <input type="text" class="form-control" id="equipment_contractor" name="equipment_contractor" placeholder="Ví dụ: FLSmidth (Đan Mạch), Loesche (Đức)">
                    </div>

                    <div class="col-md-6">
                        <label for="design_consultant" class="form-label fw-bold">9. Đơn vị tư vấn thiết kế xây dựng</label>
                        <input type="text" class="form-control" id="design_consultant" name="design_consultant" placeholder="Ví dụ: Công ty Cổ phần Tư vấn Kỹ thuật MTECH">
                    </div>

                    <div class="col-md-6">
                        <label for="supervision_consultant" class="form-label fw-bold">10. Đơn vị tư vấn giám sát</label>
                        <input type="text" class="form-control" id="supervision_consultant" name="supervision_consultant" placeholder="Ví dụ: Công ty Cổ phần Tư vấn Kỹ thuật MTECH">
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card h-100">
                            ...
                            <div class="card-body text-center">
                                <div class="mb-3">
                                    <img id="main-image-preview" src="/assets/images/placeholder-project.jpg" alt="Preview" class="img-thumbnail" style="max-height: 200px; width: 100%; object-fit: cover;">
                                </div>
                                <input type="file" class="form-control" id="image" name="image" accept="image/*" onchange="previewMainImage(this)">
                                <div class="form-text">Ảnh hiển thị trên danh sách và slide đầu tiên</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="gallery" class="form-label">Chọn thêm nhiều ảnh cho Slider:</label>
                                    <input type="file" class="form-control" id="gallery" name="gallery[]" accept="image/*" multiple onchange="previewGalleryImages(this)">
                                    <div class="form-text">Có thể chọn nhiều ảnh cùng lúc để tạo slide chuyển ảnh tự động</div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Mô tả tóm tắt về dự án..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status">
                                <option value="1" selected>Kích hoạt (Hiển thị)</option>
                                <option value="0">Vô hiệu hóa (Ẩn)</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="Tiêu đề SEO">
                        </div>
                        
                        <div class="mb-3">
                            <label for="meta_description" class="form-label fw-bold">Meta Description</label>
                            <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="Mô tả SEO"></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="admin-form-actions p-3 border-top bg-light text-end">
            ...
            <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-lg me-1"></i>Lưu dự án</button>
        </div>
    </div>
</form>
